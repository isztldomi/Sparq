...
namespace Sparq.DataAccess.Migrations
{
    ...
    [Migration("20260505202022_AddMediaAndQuestionMediaRelation")]
    partial class AddMediaAndQuestionMediaRelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sparq.DataAccess.Models.Question", b =>
                {
                    b.HasOne("Sparq.DataAccess.Models.Media", "Media")
                        .WithOne()
                        .HasForeignKey("Sparq.DataAccess.Models.Question", "MediaId")
